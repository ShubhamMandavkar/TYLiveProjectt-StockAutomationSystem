...
class Ui_stockDetails(object):
    def setupUi(self, stockDetails):
        ...
        self.lblSymbol.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)

        self.formLayout_2.setWidget(2, QFormLayout.LabelRole, self.lblSymbol)
        ...
        self.formLayout_2.setWidget(2, QFormLayout.FieldRole, self.lblSymbolVal)

        self.lblCompany = QLabel(self.frame_6)
        self.lblCompany.setObjectName(u"lblCompany")
        self.lblCompany.setFont(font1)

        self.formLayout_2.setWidget(3, QFormLayout.LabelRole, self.lblCompany)
        ...
        self.formLayout_2.setWidget(3, QFormLayout.FieldRole, self.lblCompanyVal)

        self.lblExchange = QLabel(self.frame_6)
        self.lblExchange.setObjectName(u"lblExchange")
        self.lblExchange.setFont(font1)

        self.formLayout_2.setWidget(4, QFormLayout.LabelRole, self.lblExchange)
        ...
        self.formLayout_2.setWidget(12, QFormLayout.LabelRole, self.lblVolume)

        self.lblVolumeVal = QLabel(self.frame_6)
        self.lblVolumeVal.setObjectName(u"lblVolumeVal")
        self.lblVolumeVal.setFont(font3)

        self.formLayout_2.setWidget(12, QFormLayout.FieldRole, self.lblVolumeVal)
        ...
        self.btnBuy.setMaximumSize(QSize(100, 16777215))
        ...
        self.btnSell.setMaximumSize(QSize(100, 16777215))
        ...
        self.menubar.setGeometry(QRect(0, 0, 936, 25))
